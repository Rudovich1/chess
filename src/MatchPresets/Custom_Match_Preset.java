...
public class Custom_Match_Preset extends Abstract_Match_Preset{
    ...
    Custom_Match_Preset(int first_player_time, int second_player_time, Colour first_player_colour,
    ...
    public Abstract_Match_Preset clone() throws CloneNotSupportedException {
        ...
        return (new Custom_Match_Preset(first_player_time, second_player_time, first_player_colour, first_player_сastling, second_player_castling, start_position.clone()));
